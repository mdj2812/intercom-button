...
echo "Store the PEM as GitHub Actions secret OTA_PRIVATE_KEY (release.yml) and the same value as Gitea secret OTA_PRIVATE_KEY (or HIL_OTA_KEY path on the HIL runner) so HIL can sign planted images."
