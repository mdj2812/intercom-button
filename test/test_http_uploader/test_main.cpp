...
void test_upload_success(void) {
    ...
    bool result = HTTPUploader::upload(test_data, sizeof(test_data),
                                        "10.0.0.1", 5000, "kitchen");
...
void test_upload_null_data_returns_false(void) {
    bool result = HTTPUploader::upload(nullptr, 1024,
                                        "10.0.0.1", 5000, "room");
...
void test_upload_zero_size_returns_false(void) {
    bool result = HTTPUploader::upload(test_data, 0,
                                        "10.0.0.1", 5000, "room");
    TEST_ASSERT_FALSE(result);
}
...
void test_upload_sets_content_type_wav(void) {
    ...
    HTTPUploader::upload(test_data, sizeof(test_data),
                         "server", 1234, "office");
